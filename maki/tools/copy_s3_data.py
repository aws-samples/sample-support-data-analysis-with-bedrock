...
Usage:
    python maki/tools/copy_s3_data.py to-temp    # Copy from main bucket to temp storage
    python maki/tools/copy_s3_data.py from-temp  # Restore from temp storage to main bucket
