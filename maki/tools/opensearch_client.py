...
Usage:
    python maki/tools/opensearch_client.py                    # Show current settings
    python maki/tools/opensearch_client.py --size 50         # Set query size limit
    python maki/tools/opensearch_client.py --endpoint        # Auto-detect endpoint
    python maki/tools/opensearch_client.py --count           # Count records in index
