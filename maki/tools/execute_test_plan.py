...
Usage:
    python maki/tools/execute_test_plan.py                    # Execute full test plan
    python maki/tools/execute_test_plan.py --test-case 3      # Execute only Test 3
    python maki/tools/execute_test_plan.py --check-files-only # Only validate S3 outputs
