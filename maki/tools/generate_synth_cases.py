...
Usage:
    python maki/tools/generate_synth_cases.py                           # Generate default cases
    python maki/tools/generate_synth_cases.py -q                       # Quick test (minimal cases)
    python maki/tools/generate_synth_cases.py --min-cases 5 --max-cases 10  # Custom range
