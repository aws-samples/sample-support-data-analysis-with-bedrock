...
Usage:
    python maki/tools/generate_synth_health_events.py                    # Generate 100 events
    python maki/tools/generate_synth_health_events.py --synth 50        # Generate 50 events
    python maki/tools/generate_synth_health_events.py --verbose         # Show detailed output
