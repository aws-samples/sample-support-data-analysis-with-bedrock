...
Executing: 
  arn:aws:states:us-east-1:REDACTED_ACCOUNT_ID:stateMachine:maki-REDACTED_ACCOUNT_ID-us-east-1-state-machine
State machine execution started: arn:aws:states:us-east-1:REDACTED_ACCOUNT_ID:execution:maki-REDACTED_ACCOUNT_ID-us-east-1-state-machine:a91b4fcc-4a95-47bb-b749-77b302afbca7
{
    "Step Name": "check-enabled_models",
    "Function ARN": "arn:aws:lambda:us-east-1:REDACTED_ACCOUNT_ID:function:maki-REDACTED_ACCOUNT_ID-us-east-1-check-enabled_models"
}
...
Execution succeeded!
...
```
{
  "caseId": "case-REDACTED_ACCOUNT_ID-muen-2025-f09f14aa1c569098",
...
### Agents for MAKI
While using traditional tools such as Business Intelligence systems can consume the JSON files generated by MAKI, MCP servers allow for an agentic interface to this data.   This additional stack is also actively being developed!